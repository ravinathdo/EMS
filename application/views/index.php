...
<html lang="zxx">
<head>
<title>Video Event Management System</title>
<!-- custom-theme -->
...
<link href="<?= base_url()?>css/JiSlider.css" rel="stylesheet"> 
		...
		<div class="container">
			<nav class="navbar navbar-default">
				<div class="navbar-header navbar-left">
					...
					<h1><a class="navbar-brand" href="index.html"><i class="fa fa-camera" aria-hidden="true"></i> Video Event Management  <p class="logo_w3l_agile_caption">On one Click</p></a></h1>
				</div>
					...
					<nav class="menu menu--iris">
						<ul class="nav navbar-nav menu__list">
							...
							<li class="menu__item"><a href="#contact" class="menu__link scroll">Contact </a></li>
                                                        <li class="menu__item"><a href="<?= base_url()?>user/login" >Login</a></li>
						</ul>
					</nav>
				</div>
			</nav>
...
<div class="agile_overlay1">
		...
		<div class="container">
		      <div class="cam"><a href="index.html"><i class="fa fa-camera" aria-hidden="true"></i></a></div>
			...
			<div class="copy-right">
				<p>© 2017 Video Event Management. All rights reserved | Design by <a href="">Imalka</a></p>
			</div>
		</div>
	</div>
</div>
...
<script src="<?= base_url()?>js/JiSlider.js"></script>
		<script>
