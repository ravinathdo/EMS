        ...
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                ...
                <section class="content">
                    <div class="row">
                        <div class="col-md-5">
                            <h2>View Employee Event</h2>
                            <?php echo form_open('report/employeeEvent'); ?>
                            Employee <select class="form-control" name="empid">
                                <?php if ($employee_list != FALSE) {
                ...
                ?>
                            ...
                            <?php if (isset($employeeEvent)) { ?>


                                <center><h2>Event Management System - Employee Event Report</h2>
                                ...
                                <table class="table  table-bordered">
                                    ...
                                    <tbody>
                                        <?php
                                        if ($employeeEvent != FALSE) {
                                            foreach ($employeeEvent as $rows) {
                                                ?>
                                                <tr>
                                                    <td><?= $rows->id; ?></td>
